      ...
      <div className="flex-1 min-w-0 space-y-5">
        ...
        <div id="sec-grafico" style={{ scrollMarginTop: `${HDR + 12}px`, backgroundColor: C.white, borderRadius: 16, padding: 20, boxShadow: '0 1px 4px rgba(2,32,88,0.08)' }}>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={c.chart} margin={{ top: 5, right: 10, bottom: 22, left: 5 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(2,32,88,0.07)" />
              <XAxis dataKey="ano" label={{ value: 'Anos', position: 'insideBottom', offset: -12, fontSize: 11, fill: T.low }} tick={{ fontSize: 11, fill: T.low }} />
              <YAxis tickFormatter={fmtK} width={88} tick={{ fontSize: 10, fill: T.low }} />
        ...
        <div id="sec-tabelas" style={{ scrollMarginTop: `${HDR + 12}px`, backgroundColor: C.white, borderRadius: 16, overflow: 'hidden', boxShadow: '0 1px 4px rgba(2,32,88,0.08)' }}>
          <div className="px-5 pt-4 pb-3 relative flex items-center justify-end" style={{ borderBottom: `1px solid ${C.border}` }}>
            <p className="absolute left-1/2 -translate-x-1/2 text-xs font-semibold uppercase tracking-widest whitespace-nowrap" style={{ color: T.med }}>
          ...
          <ComparativeTable columns={columns} rows={displayRows} />
